...
class model{
    ...
    function getTipoDocumentos(){
        ...
        $sql = "call spGetAllTipoDocPagoCxP (@out_status);";
    ...
    function buscarFactCliente($selCliente) {
        ...
        $sql = "call spGetAllFactuCliCxP($selCliente,'S',@out_status);";
  //      echo $sql;exit;
        $rs = $this->db->Execute($sql);
  ...
  //      echo $sql;exit;
    ...
    function aplicaRecibo($selCliente,$numero,$montoRecibo,$obs,$fecRecibo,$tipoPago,$idTienda,$tableData) {
        ...
        $sql = "call spInsPagoCxP($selCliente,$idTienda,'$numero',$montoRecibo,'$obs','$fecRecibo',$tipoPago,@out_numeroRecibo,@out_status);";
        //  echo $sql;exit;
        $rs = $this->db->Execute($sql);
        $rs->Close();
        ...
        foreach ($tableData as $key => $docu) {
            ...
            $sql = "call spApliPagoCxP($selCliente,'$numRecibo','$numeroFactura',$montoAplica,'$fecRecibo',@out_status);";
          //    echo $sql;exit;
            $rs = $this->db->Execute($sql);
            $rs->Close();
