<?php
    ...
    $infoRecibos = $model->buscarRecibosCxP($idCliente,$tipodoc,$Criterio,$fechaI,$fechaF);
    ...
    $mvc->assign("TIT_REPORTE" ,"Documentos CxP");
    $mvc->assign("TIT_EXPORT" ,"Documentos  CxP");
    $mvc->assign("NOMBRE_CLIENTE" ,$nombreCliente);
              
    $page = $mvc->fetch("repDocumentos.tpl");
