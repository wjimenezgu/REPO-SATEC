$(document).ready(function(){
	...
	{
                var theme_name = "classic"; //Esto puede cambiar dinamicamente
		$('#bs-css').attr('href','http://'+nameServer+'/'+nameAPP+'/resources/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	var elf = $('.file-manager').elfinder({
		url : 'resources/misc/elfinder-connector/connector.php'  // connector URL (REQUIRED)
	}).elfinder('instance');
	...
	$('#file_upload').uploadify({
		...
		'uploader' : 'resources/misc/uploadify.php'
	...
	$('.datatable').dataTable({                        
			...
			"sPaginationType": "bootstrap",
                        'iDisplayLength': 20,
                        "aLengthMenu": [[20, 40, 60, 80, -1], [20, 40, 60, 80, "Todos"]],
			"oLanguage": {
