<?php
   ...
   // hasta aqui codigo agregado
    ...
    $idOpcionPago = $_GET["id"];
    
    $infoOpcionPago = $model->buscarDetalleOpcionPago($idOpcionPago);
    
    $mvc->assign("ID_OPCIONPAGO", $idOpcionPago);
    $mvc->assign("OPCIONPAGO", $infoOpcionPago);   
    
    $page = $mvc->fetch("editOpcionPago.tpl");
