<?php
   ...
   // hasta aqui codigo agregado
    ...
    $infoTipoDocumento = $model->buscarDetalleTipoDocumento($idTipoDocumento);
    
    // Se crear la variable PROVEEDOR en el $mvc para utilarla dentro del procedimiento
    $mvc->assign("ID_TIPODOCUMENTO", $idTipoDocumento);
    $mvc->assign("TIPODOCUMENTO", $infoTipoDocumento);        

    $page = $mvc->fetch("editTipoDocumento.tpl");
