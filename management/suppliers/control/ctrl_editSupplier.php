<?php
   ...
   // hasta aqui codigo agregado        
    ...
    $infoProveedor      = $model->buscarDetalleProveedor($idProveedor);
    $PaymentOptionsList = $model->getAllPaymentsOptions();    
   
    $mvc->assign("ID_PROVEEDOR", $idProveedor);
    $mvc->assign("PROVEEDOR", $infoProveedor);
    $mvc->assign("PAYMENTSOPTIONS_LIST", $PaymentOptionsList);  
   
    $page = $mvc->fetch("editSupplier.tpl");
