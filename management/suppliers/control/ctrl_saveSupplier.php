<?php
    ...
    $resultInsertar = $model->insertarProveedor($idProveedor,$nombreProveedor,$cedulajuridica,$direccion,$pais,$apartado,
                                                  $zipcode,$telefono,$fax,$obligatoriocosto,$idOpcionPago);
