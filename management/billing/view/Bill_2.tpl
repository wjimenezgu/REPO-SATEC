                    ...
                    <div class="row-fluid" >		
                                    ...
                                    <div class="box-header well" data-original-title>
                                            ...
                                            <select class="pull-right" id="selectStore[]" name="selectStore[]" > 
                                                 {section name=lP loop=$LISTA_TIENDAS}
                                                  <option value="{$LISTA_TIENDAS[lP].idTienda}">{$LISTA_TIENDAS[lP].descTienda}</option>
                                                 {/section}
                                            </select>
                                    </div>
						...
						<div class="controls">
                                                    <select style="width: 600px; height: 30px;" id="selectError1" name ="selectError1[]" data-rel="chosen">
                                                           ...
                                                           <option value="{$LISTA_CLIENTES[lP].idCliente}" {if $LISTA_CLIENTES[lP].idCliente eq 1} selected{/if} > {$LISTA_CLIENTES[lP].nombre} | {$LISTA_CLIENTES[lP].telefono} | {$LISTA_CLIENTES[lP].correo}</option>
                                                            {/section}
                                                    </select>
                                                    ...
                                                    <select data-placeholder="Seleccionar Articulo" style="width: 880px; height: 30px;" id="selectError" data-rel="chosen">
                                                           <option value="0"></option>
                                                            {section name=lP loop=$LISTA_ITEMS}
                                                                <option >{$LISTA_ITEMS[lP].codArti} | {$LISTA_ITEMS[lP].desArticulo} | {$LISTA_ITEMS[lP].cantidad} | {$LISTA_ITEMS[lP].precio}</option>
                                                            {/section}
                                                    </select>
