<?php
    ...
    $infoNivelesEnse = $model->getAllNivelesEnseData();
    ...
    switch ($action){
    	...
    	case 2:
			...
			// del registro a modificar.  
   			...
   			$infoAsignaNivelesEnse = $model->buscarDetalleNivelesEnse($id);
    ...
    $mvc->assign("DATA_NIVELESENSE"    , $infoNivelesEnse);
    $mvc->assign("DATA_ASIGNANIVELESENSE"    , $infoAsignaNivelesEnse);
