					...
					{section name=lP loop=$LISTA_DATA} 								
						<tr style="padding:0px;" id="tr{$LISTA_DATA[lP].nombre}">
							...
							<td style="width:30%;font-family:monospace;" class="center">
								...
								<a class="btn btn-danger" style="display: none;" ="#" id="{$LISTA_DATA[lP].nombre}" title="Eliminar Par&aacute;" data-rel="tooltip" onclick="goPage(3, this.id)"><i class="icon-trash icon-white"></i> Eliminar</a> 		
