<?php
    ...
    //                         array("opt"=>$LANGUAGE_VARS["module_1_option_3"], "link"=>"http://".CRM_SERVER."/".$partsLink[1]."/".$partsLink[2]."/".$partsLink[3]."/".$partsLink[4])
    //                        );  
    ...
    $listPedidos = $model->getAllPedidos();
    
    $mvc->assign("LIST_PEDIDOS", $listPedidos);    

    $page = $mvc->fetch("frmListOrders.tpl");
