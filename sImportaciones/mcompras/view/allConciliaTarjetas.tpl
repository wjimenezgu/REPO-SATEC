			...
			<table class="table table-striped table-bordered bootstrap-datatable" id="tblRegs">
				...
				{section name=lP loop=$LISTA_REGS} 								
					<tr style="padding:0px;">
     					<td style="width:120px;">{$LISTA_REGS[lP].Tarjeta}</td>
     					<td style="width:150px;">{$LISTA_REGS[lP].FechaCorte}</td>
						<td class="center">
							<a href="#" id="{$LISTA_REGS[lP].NumTarjeta}|{$LISTA_REGS[lP].FechaCorte}|{$LISTA_REGS[lP].idProveedor}" onclick="goPage(2, this.id)"><i class="icon icon-color icon-edit"></i></a>
							<a href="#" id="{$LISTA_REGS[lP].NumTarjeta}|{$LISTA_REGS[lP].FechaCorte}|{$LISTA_REGS[lP].idProveedor}" onclick="goPage(6, this.id)"><i class="icon icon-color icon-print"></i></a>
							<!-- <a href="#" id="{$LISTA_REGS[lP].NumTarjeta}|{$LISTA_REGS[lP].FechaCorte}|{$LISTA_REGS[lP].idProveedor}" onclick="goPage(3, this.id)"><i class="icon icon-color icon-remove"></i></a>  -->
						</td>
					</tr> 
				{/section}
			 </table>  					            
