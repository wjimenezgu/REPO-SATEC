							  ...
							  <tbody> 
                                                                ...
                                                                <tr class="numRow{$smarty.section.e.index+1}" id="register">
                                                                        ...
                                                                        <td class="evalActions">
                                                                            ...
                                                                            <a href="editOrder.php?id={$LIST_PEDIDOS[p].idPedido}" title="Modificar Documento" data-rel="tooltip" style="margin-right:3px;"><i class="icon icon-color icon-edit"></i></a>
                                                                            -->																			
																			<button type="button" class="btn btn-small btn-success" id="btnUpdDocument" data-toggle="modal" title="Modificar Documento" data-rel="tooltip" data-target="#newDoc-modal"><i class="icon icon-color icon-edit"></i></button>
                                                                        </td>                                                                        
								</tr> 
                                                                {/section}
<!--                                                                 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 id="titModal" class="modal-title blue"><i class="fa fa-bars"></i> Nuevo Documento</h3>
                <br />
                          ...
                          <tr>
                              ...
                              <td>
                                <div class="pull-left control-group" id="input-desgloMonto">
                                    <input type="text" class="input-block-level" id="desmonto1" name="desmonto1" value="0.00"><br>
                                    <input type="text" class="input-block-level" id="desmonto2" name="desmonto2" value="0.00"><br>
                                    <input type="text" class="input-block-level" id="desmonto3" name="desmonto3" value="0.00"><br>
                                    <input type="text" class="input-block-level" id="desmonto4" name="desmonto4" value="0.00"><br>
                                    <input type="text" class="input-block-level" id="desmonto5" name="desmonto5" value="0.00">
                                </div>                                 
                              </td>
                          </tr>                            
                          <tr>
...
//           startDate: new Date()
        ...
        $("#btnUpdDocument").on("click", function (e){


        	$("#titModal").html("Modificar Documento");
        	$("#addDocument").html("Actualizar");
        	var vmontoDoc = {$ALL_DOCUMENTS[e].userInsDoc};
            $('#docsList').prop('selectedIndex',0);             
            var textReset = $("#docsList option:selected").text();
            
            $("#newDoc").find('a.chzn-single').find("span").text(textReset);            
            //$('#comments').val("");
            $('#comments').val(vmontoDoc);
            $('#dateDocument').val("");  
            $('#noDocument').val("");  
            $('#monto').val("");  
            $('#selMoneda').prop('selectedIndex',0);
        ...
        $("#addDocument").on("click", function (e){
            ...
            var infoDocument = {
                    ...
                    async: true,
                    cache: false,
                    data: "idPedido="+cache.$idPedido.val()+"&idDocumento="+cache.$selDocument.val()+"&nameDoc="+$('#docsList option:selected').text()+"&dateDocument="+cache.$date.val()+"&noDocument="+cache.$noDocument.val()+"&monto="+cache.$monto.val()+"&selMoneda="+cache.$selMoneda.val()+"&comment="+cache.$comment.val()+"&desmonto1="+cache.$desmonto1.val()+"&desmonto2="+cache.$desmonto2.val()+"&desmonto3="+cache.$desmonto3.val()+"&desmonto4="+cache.$desmonto4.val()+"&desmonto5="+cache.$desmonto5.val(),
                    type: "POST",
                    dataType: "json",
