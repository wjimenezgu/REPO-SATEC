<?php /* Smarty version Smarty-3.1.16, created on 2016-09-05 09:55:31
         compiled from "../mcompras/view/frmNewOrder.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1089577172541c933459a602-85686110%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9e14023d729d32cf990adaf221359cd2430907a0' => 
    array (
      0 => '../mcompras/view/frmNewOrder.tpl',
      1 => 1473090925,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1089577172541c933459a602-85686110',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_541c93346ee854_16797536',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'PROVEEDORES' => 0,
...
<?php if ($_valid && !is_callable('content_541c93346ee854_16797536')) {function content_541c93346ee854_16797536($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.capitalize.php';
if (!is_callable('smarty_modifier_truncate')) include '/var/www/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.truncate.php';
...
"><?php echo smarty_modifier_capitalize(mb_strtolower($_smarty_tpl->tpl_vars['PROVEEDORES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['nombreProveedor'], 'UTF-8'));?>
</option>
                                        <?php endfor; endif; ?>
                                    </select>                                    
                            ...
                            <div class="row-fluid" >
                                    ...
                                    <div class="span6">                                        
                                        <div class="pull-left control-group" id="input-datePedido">
                                            <input type="text" class="input-block-level datepicker" id="datePedido" name="datePedido" style="width:122px" disabled value="<?php echo $_smarty_tpl->tpl_vars['CURRENT_DATE']->value;?>
">
                                        </div>
                                    </div>
                            </div>                                              
...
" disabled> <?php echo smarty_modifier_capitalize(mb_strtolower($_smarty_tpl->tpl_vars['LIST_OPT_PAGO']->value[$_smarty_tpl->getVariable('smarty')->value['section']['opt']['index']]['descripcion'], 'UTF-8'));?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['tc']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['tc']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['tc']['total']);
?>
 											<?php if ($_smarty_tpl->tpl_vars['ALL_TIP_CARDS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['tc']['index']]['idTarjeta']=='0') {?>
...
?>
                                                                                                <?php if ($_smarty_tpl->tpl_vars['COMPROMISOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['co']['index']]['descripcion']=="STOCK") {?>
