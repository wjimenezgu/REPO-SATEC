<?php /* Smarty version Smarty-3.1.16, created on 2016-03-16 11:12:50
         compiled from "../mcompras/view/frmEventRegister.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30012401354237c34915c25-42853660%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b223da13a107edb4db0489acd9ddb088913bbbad' => 
    array (
      0 => '../mcompras/view/frmEventRegister.tpl',
      1 => 1457810178,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30012401354237c34915c25-42853660',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_54237c349ba482_95337359',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'REGISTER' => 0,
...
<?php if ($_valid && !is_callable('content_54237c349ba482_95337359')) {function content_54237c349ba482_95337359($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/html/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.capitalize.php';
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <br />
                <p>Registrar evento al pedido</p>
            </div>
    ...
    $(document).ready(function(){
        ...
        $("#addEvent").on("click", function (e){
            ...
            var infoEvent = {
                    ...
                    async: true,
                    cache: false,
                    data: "idPedido="+cache.$idPedido.val()+"&idEvento="+cache.$selEvento.val()+"&nameEvent="+$('#eventList option:selected').text()+"&comment="+cache.$comment.val(),
                    type: "POST",
                    dataType: "json",
