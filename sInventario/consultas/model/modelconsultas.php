...
class modelconsultas{
    ...
    function buscarExistencias($tienda,$fechaCorte,$criterio, $texto) {
 	...
 	//  echo $sql;exit;
      ...
      function buscarVentasxArticulo($criterio,$codtienda,$fechaI,$fechaF,$texto) {
    
        $sql = "call spGetArtiExistenciasMoviFecha('$criterio',$codtienda,'$fechaI','$fechaF','$texto',@out_status);";
        //echo $sql;exit;
        $rs = $this->db->Execute($sql);
    ...
    function buscarDetItemMoviT($idItem,$idTienda) {
     ...
     function buscarItemMoviTPeriodo($codtienda,$texto,$codTipoMov,$fechaI,$fechaF) {
    
        $sql = "call spGetItemMoviTPeriodo($codtienda,'$texto','$codTipoMov','$fechaI','$fechaF',@out_status);";
        //echo $sql;exit;
        $rs = $this->db->Execute($sql);
