<table class="table table-condensed bootstrap-datatable" id="tblAllInventary" style="width:750px">
  ...
  <tbody> 
    ...
    <tr id="inv-rowArt1">
        ...
        <td class="center">
            <a class="btn btn-mini btn-info" data="{$INVENTARIO[i].codArti}|{$INVENTARIO[i].desArticulo|lower|capitalize}|{$INVENTARIO[i].precio}|{$INVENTARIO[i].ExisLocal}"><i class="icon-plus icon-white"></i> Añadir</a>
        </td>        
    </tr>
    {/section}    
