<?php 
    ...
    $action     	= $_GET["action"]; // puede ser: 6:facturar reparacion, 8:facturar adelanto
    ...
    $headerRepa  = $model->buscarDetalleRepaFactu($idTienda,$idDoc);
    
    if ($action == 6){ // imprimir factura de la reparacion
    	
    }else{ // imprimir factura del adelanto
    ...
    $lineasPie   = $model->buscarLineasPie('F');  // se imprime la misma leyenda que las facturas
...
<body>
    ...
    <div style="width:100%">
            ...
            <input type="button" id="imprime" autofocus name="imprime"   style="margin-left:25%; margin-top:25%;font-size:48px" onclick="javascript:jsWebClientPrint.print('cmds=' + $('#cmds').val());window.location.href ='../facturacion/index.php';" value="Presionar Enter para volver al sistema ..." />
