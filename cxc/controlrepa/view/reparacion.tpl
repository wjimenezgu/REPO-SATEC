		...
		<div class="box span12">
			...
			<!-- 		<div class="control-group" id="boxFechaRecibido" >
					...
					<div class="control-group" id="boxTienda" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="ftienda" id="ftienda" maxlength="100" type="text" value="{$REPARACION[0].nombreTienda}" readonly="true">
						</div>
				 	</div>					 								
                    		...
                    		<div class="control-group" id="boxFinRepa">
								...
								<div class="controls">
									<select id="selectFinRepa" name ="selectFinRepa" style="width: 275px;">
                            			<option value="SI" {if $REPARACION[0].estado == "R" || $REPARACION[0].estado == "F"} selected{/if}>Si</option>						
                            			<option value="NO" {if $REPARACION[0].TotalReparacion == "0.00"} selected{/if}>No</option>
                        			</select>
                        		</div>
                    		</div>
                    	</td>				 	
					...
					<div class="control-group" id="boxTotalReparacion" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fTotalReparacion" id="fTotalReparacion" type="text" value="{$REPARACION[0].TotalReparacion}" style="text-align: right;width: 100px;margin-left:-50px">
						</div>
				 	</div>
				 	</td>
				 	                    	<td style="width:150px;text-align:left">
