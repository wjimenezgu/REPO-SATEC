<?php /* Smarty version Smarty-3.1.16, created on 2016-02-11 07:51:07
                    		...
                    		<div class="control-group" id="boxFinRepa">
								...
								<div class="controls">
									<select id="selectFinRepa" name ="selectFinRepa" style="width: 275px;">
                            			<option value="SI" <?php if ($_smarty_tpl->tpl_vars['REPARACION']->value[0]['TotalReparacion']!="0.00") {?> selected<?php }?>>Si</option>									
