<?php /* Smarty version Smarty-3.1.16, created on 2016-07-10 08:04:10
         compiled from "../controlrepa/view/frmEventRegister.tpl" */ ?>
<?php /*%%SmartyHeaderCode:288071927578245c6420007-86969464%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f14b49d10174e19c04832425445607ef35cdabfe' => 
    array (
      0 => '../controlrepa/view/frmEventRegister.tpl',
      1 => 1468159301,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '288071927578245c6420007-86969464',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_578245c64eecb3_53951390',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'REGISTER' => 0,
...
<?php if ($_valid && !is_callable('content_578245c64eecb3_53951390')) {function content_578245c64eecb3_53951390($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/html/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.capitalize.php';
...
">
                    <legend style="height:35px; text-align:right;">                                                
						...
						<a href="index.php" class="btn btn-small btn-info" data-dismiss="modal">Cerrar</a>
                    </legend>
                    ...
                    <table class="table table-condensed">
                      <tbody> 
						<tr>
                              <th>Vendedor</th>
                              <td>                                 
                                 <input class="input-small focused" required name ="fVendedorE" id="fVendedorE" type="text" value=" "> 
                              </td>
                          </tr>
                          <tr>
                              <th>Evento</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#addEvent").on("click", function (e){
            ...
            var errores = false;
            var largoCampo = 0;
            document.getElementById('message-newArticle').innerHTML = "";
            largoCampo = $.trim($("#fVendedorE").val()).length;
            if (largoCampo == 0){
            	document.getElementById('message-newArticle').innerHTML = "<div class='alert alert-error center' style=''><strong><span class='icon icon-red icon-alert'/></span> Campo Vendedor en Blanco.</strong></div>";
            	errores = true;
            }
            // se valida que haya seleccionado el vendedor
            if (cache.$selEvento.val() == 0){
            	document.getElementById('message-newArticle').innerHTML = "<div class='alert alert-error center' style=''><strong><span class='icon icon-red icon-alert'/></span> Obligatorio seleccionar Evento.</strong></div>";
            	errores = true;
            }
            ...
            var infoEvent = {
                    ...
                    async: true,
                    cache: false,
                    data: "idReparacion="+cache.$idReparacion.val()+"&idEvento="+cache.$selEvento.val()+"&nameEvent="+$('#eventList option:selected').text()+"&comment="+cache.$comment.val()+"&vendedor="+cache.$vendedor.val(),
                    type: "POST",
                    dataType: "json",
