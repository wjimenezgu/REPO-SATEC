<?php /* Smarty version Smarty-3.1.16, created on 2016-07-19 18:44:48
         compiled from "../controlrepa/view/reparacion.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162849468057823ab642e480-32958706%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8f71d2315634f0b0c4be28f9c0161f3a257944af' => 
    array (
      0 => '../controlrepa/view/reparacion.tpl',
      1 => 1468975475,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '162849468057823ab642e480-32958706',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_57823ab64b27b6_36564069',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'NOMBRE_TIENDA' => 0,
...
<?php if ($_valid && !is_callable('content_57823ab64b27b6_36564069')) {function content_57823ab64b27b6_36564069($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
...
">
 			 	...
 			 	<fieldset>
					...
					<div class="control-group" id="boxId" >
						...
						<div class="controls">
							<input class="input-xlarge " name="fIdReparacion" id="fIdReparacion" type="text" placeholder="<?php echo $_smarty_tpl->tpl_vars['ID_REPARACION']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['ID_REPARACION']->value;?>
" readonly="true">
						</div>
					</div>
					</td>
			...
			<!-- 		<div class="control-group" id="boxFechaRecibido" >
						...
						<div class="controls">
							<input class="input-xlarge datepicker focused" name ="fFechaRecibido" id="fFechaRecibido"  type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['FechaRecibido'];?>
">
						</div>
				 	</div>	  -->	
					<div class="control-group" id="boxTienda" >
						<label class="control-label" for="focusedInput">Tienda</label>
						<div class="controls">
							<input class="input-xlarge focused" name ="ftienda" id="ftienda" maxlength="100" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['nombreTienda'];?>
" readonly="true">
						</div>
				 	</div>					 								
					<div class="control-group" id="boxEquipo" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fEquipo" id="fEquipo" maxlength="100" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['Equipo'];?>
" >
						</div>
				 	</div>	
					<div class="control-group" id="boxModelo" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fModelo" id="fModelo" maxlength="50" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['Modelo'];?>
" >
						</div>
				 	</div>
					<div class="control-group" id="boxMarca" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fMarca" id="fMarca" maxlength="50" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['Marca'];?>
" >
						</div>
				 	</div>
					<div class="control-group" id="boxSerie" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fSerie" id="fSerie" maxlength="50" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['Serie'];?>
">
						</div>
				 	</div>
					<div class="control-group" id="boxAccesorios" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fAccesorio" id="fAccesorio" maxlength="100" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['Accesorios'];?>
">
						</div>
				 	</div>				 	
					<div class="control-group" id="boxProblema" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fProblema" id="fProblema" maxlength="300" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['Problema'];?>
">
						</div>
				 	</div>
					<div class="control-group" id="boxObs" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fObs" id="fObs" maxlength="300" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['Obs'];?>
">
						</div>
				 	</div>
				 	<table>
...
|<?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['correoElectronico'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['telefono'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['nombreContacto'];?>
" <?php if ($_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['id']==$_smarty_tpl->tpl_vars['REPARACION']->value[0]['idCliente']) {?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['nombre'];?>
 | <?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['correoElectronico'];?>
 | <?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['telefono'];?>
 | <?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['nombreContacto'];?>
</option>
					...
					<table>
                    		...
                    		<div class="control-group" id="boxGarantia">
								...
								<div class="controls">
									<select id="selectGarantia" name ="selectGarantia" style="width: 275px;">
                            			<option value="NO" <?php if ($_smarty_tpl->tpl_vars['REPARACION']->value[0]['Garantia']=="N") {?> selected<?php }?>>No</option>
                            			<option value="SI" <?php if ($_smarty_tpl->tpl_vars['REPARACION']->value[0]['Garantia']=="S") {?> selected<?php }?>>Si</option>
                        			</select>
                        		</div>
                    		</div>
                    	</td>
                    	<td>
                    		<div class="control-group" id="boxNumFactura" >
								...
								<div class="controls">
									<input class="input-xlarge focused" name ="fNumFactura" id="fNumFactura" maxlength="15" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['FacGarantia'];?>
">
								</div>
				 			</div>
                    	</td>
					...
					<div class="control-group" id="boxAdelanto" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fAdelanto" id="fAdelanto" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['Adelanto'];?>
" style="text-align: right;">
				 	    ...
				 	    <td>
                    		<div class="control-group" id="boxNumFacAdelanto" >
								...
								<div class="controls">
									<input class="input-xlarge focused" name ="fNumFacAdelanto" id="fNumFacAdelanto" maxlength="15" disabled type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['NumFacAdelanto'];?>
">
								</div>
				 			</div>
                    	</td>	
					...
					<div class="control-group" id="boxManoDeObra" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fManoDeObra" id="fManoDeObra" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['ManoDeObra'];?>
" style="text-align: right;">
						</div>
				 	</div>	
				 	<table>
						<tbody>
                    		...
                    		<div class="control-group" id="boxFinRepa">
								...
								<div class="controls">
									<select id="selectFinRepa" name ="selectFinRepa" style="width: 275px;">
                            			<option value="SI" <?php if ($_smarty_tpl->tpl_vars['REPARACION']->value[0]['estado']=="R"||$_smarty_tpl->tpl_vars['REPARACION']->value[0]['estado']=="F") {?> selected<?php }?>>Si</option>						
                            			<option value="NO" <?php if ($_smarty_tpl->tpl_vars['REPARACION']->value[0]['TotalReparacion']=="0.00") {?> selected<?php }?>>No</option>
                        			</select>
                        		</div>
                    		</div>
                    	</td>				 	
					...
					<div class="control-group" id="boxTotalReparacion" >
						...
						<div class="controls">
							<input class="input-xlarge focused" name ="fTotalReparacion" id="fTotalReparacion" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['TotalReparacion'];?>
" style="text-align: right;width: 100px;margin-left:-50px">
						</div>
				 	</div>
				 	</td>
				 	                    	<td style="width:150px;text-align:left">
                    		<div class="control-group" id="boxNumFacturaRepa" >
								...
								<div class="controls">
									<input class="input-xlarge focused" disabled name ="fNumFacturaRepa" id="fNumFacturaRepa" style="width: 100px; margin-left:-100px" maxlength="15" type="text" value="<?php echo $_smarty_tpl->tpl_vars['REPARACION']->value[0]['numDocu'];?>
">
								</div>
				 			</div>
                    	</td>
 					...
 					<div class="modal-footer">
						<button id=btnSubmit type="submit" name="btnSubmit" class="btn btn-large btn-primary pull-right"><?php echo $_smarty_tpl->tpl_vars['BTN_ACTION']->value;?>
</button>
