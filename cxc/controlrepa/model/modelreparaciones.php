...
class modelreparaciones{
	...
	function getAllReparacionesGen($criterio){
            $sql = "call spGetAllReparacionesGen('$criterio',@out_status);";
    ...
    function buscarDetalleReparacionGen($idReparacion) {
    
    	$sql = "call spGetEncReparacionGen($idReparacion,@out_status);";
