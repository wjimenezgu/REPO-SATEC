<?php /* Smarty version Smarty-3.1.16, created on 2016-09-20 19:41:57
         compiled from "../facturacion/view/inventory.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20780900965512d9aacd3996-12009447%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '03ac053a5a103774f0ef0348fc14b5b5f6437ed6' => 
    array (
      0 => '../facturacion/view/inventory.tpl',
      1 => 1471877279,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20780900965512d9aacd3996-12009447',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5512d9aad90558_29163965',
  'variables' => 
  array (
    'COSTO_OFF' => 0,
    'INVENTARIO' => 0,
...
<?php if ($_valid && !is_callable('content_5512d9aad90558_29163965')) {function content_5512d9aad90558_29163965($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/CRM-SATEC/resources/libs/smarty/libs/plugins/modifier.capitalize.php';
...
//		precioVentaIVIStr = precioVentaIVIStr.replace(/,/g, ''); 
...
//		price.value =  $.number(precioVentaSinIVIFloat,2);
	...
	//	precioVenta.type = "text";
		...
		if ($("#fac_esp").val() == 'N'){
			...
			precioVenta.value = parseFloat(arrRes[3]).toFixed(2);			
			precioVenta.type = "number";
			precioVenta.pattern= "[0-9]*";
