<?php /* Smarty version Smarty-3.1.16, created on 2016-10-03 21:52:53
...
">
            <input type="hidden" id="fac_esp" value="<?php echo $_smarty_tpl->tpl_vars['FAC_ESP']->value;?>
">
            <input type="hidden" id="porce_max_desc" value="<?php echo $_smarty_tpl->tpl_vars['PORCE_MAX_DESC']->value[0]['MaxDesc'];?>
">
            <input type="hidden" id="porce_aut_desc" value="<?php echo $_smarty_tpl->tpl_vars['PORCE_AUT_DESC']->value[0]['MaxAutDesc'];?>
">
            <input type="hidden" id="porce_uti_costo" value="<?php echo $_smarty_tpl->tpl_vars['PORCE_UTI_COSTO']->value[0]['PorceUtiCosto'];?>
">
            <input type="hidden" id="aut_desc" value="<?php echo $_smarty_tpl->tpl_vars['AUT_DESC']->value[0]['AutDesc'];?>
">
            <input type="hidden" id="aut_desc_gere" value="<?php echo $_smarty_tpl->tpl_vars['AUT_DESC_GERE']->value[0]['AutDesc'];?>
">
            	...
            	<div class="box span12">
                	<div class="box-header well" data-original-title>
                    	<h2><?php echo $_smarty_tpl->tpl_vars['TIT_PAG']->value;?>
                    	    ...
                    	    <button type="button" id='facturar' onclick="impFactu('N')";  class="btn btn-small btn-success" style="margin-left:20px;">FACTURAR CREDITO</button>                   	    
								...
								<form class="form-horizontal" >
						            <div class="control-group" id="boxClaveVendedor" style="margin-top:20px;">	
						                ...
						                <div class="controls" id="input-fclaveVendedor">
						                	<input type="text" class=" input-large" id="fclaveVendedor" value=""> 
						                </div>                       
						            </div>                        
						            <div class="control-group" id="boxClaveAutoriza" style="display:none">	
						                ...
						                <div class="controls" id="input-fclaveAutFactu">
						                	<input type="text" class=" input-large"  id="fclaveAutFactu"  value=""> 
						                </div>                       
						            </div>
