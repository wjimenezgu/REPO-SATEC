<?php /* Smarty version Smarty-3.1.16, created on 2016-09-20 20:39:24
         compiled from "../facturacion/view/bill.tpl" */ ?>
<?php /*%%SmartyHeaderCode:414560996550dab487d6787-67508344%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8df49fb928f5ed88469d3aa22ce57355644f898a' => 
    array (
      0 => '../facturacion/view/bill.tpl',
      1 => 1474425562,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '414560996550dab487d6787-67508344',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_550dab489270f7_64310110',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'PORCE_IV' => 0,
...
<?php if ($_valid && !is_callable('content_550dab489270f7_64310110')) {function content_550dab489270f7_64310110($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
...
">
            <input type="hidden" name="fac_esp" id="fac_esp" value="<?php echo $_smarty_tpl->tpl_vars['FAC_ESP']->value;?>
">
            <input type="hidden" name="porce_max_desc" id="porce_max_desc" value="<?php echo $_smarty_tpl->tpl_vars['PORCE_MAX_DESC']->value[0]['MaxDesc'];?>
">
            <input type="hidden" name="porce_aut_desc" id="porce_aut_desc" value="<?php echo $_smarty_tpl->tpl_vars['PORCE_AUT_DESC']->value[0]['MaxAutDesc'];?>
">
            <input type="hidden" name="porce_uti_costo" id="porce_uti_costo" value="<?php echo $_smarty_tpl->tpl_vars['PORCE_UTI_COSTO']->value[0]['PorceUtiCosto'];?>
">
            <input type="hidden" name="aut_desc" id="aut_desc" value="<?php echo $_smarty_tpl->tpl_vars['AUT_DESC']->value[0]['AutDesc'];?>
">
            <input type="hidden" name="aut_desc_gere" id="aut_desc_gere" value="<?php echo $_smarty_tpl->tpl_vars['AUT_DESC_GERE']->value[0]['AutDesc'];?>
">
...
">
            ...
            <input type="hidden" name="costoArticulo" id="costoArticulo" value="">
        	<div class="row-fluid" >		
...
" <?php if ($_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['id']==$_smarty_tpl->tpl_vars['IDCLI_SINNOMBRE']->value[0]['idCliSinNombre']) {?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['nombre'];?>
 | <?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['correoElectronico'];?>
 | <?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['telefono'];?>
 | <?php echo $_smarty_tpl->tpl_vars['LISTA_CLIENTES']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['nombreContacto'];?>
</option>
								...
								<div class="control-group" style="margin-left: -150px;" id="boxCriterios">
									<div class="controls">
                						...
                						<form style="margin:0px; padding:0px; float:right; margin-top:-5px;">
                    						...
                    						<input type="text"  id="existencia" name="existencia" disabled value="" style="margin-top:4px; margin-left:20px; color:red;font-weight:bold; font-size:1.5vw; width:70px;text-align:right" placeholder="Existencia">
...
?>
			vendedorLista="<?php echo $_smarty_tpl->tpl_vars['lP']->value['userVendedor'];?>
";
			claveVendedor="<?php echo $_smarty_tpl->tpl_vars['lP']->value['passVerificador'];?>
";
