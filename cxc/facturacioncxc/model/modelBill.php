...
class modelBill{
	...
	function GetFieldHide($userName,$fieldName) {
        ...
        function insEncFacturaCxC($idCliente,$tienda,$vendedor, 
        	...
        	$sql = "call spInsEncFacturaCxC($idCliente,$tienda,'$vendedor', 
    										'$fecFactura',
    										'$posPresupestaria','$fondo','$areaFuncional','$solPedido','$tramiCompra','$ctaCliente',
    										'$oc','$indMontoLetras','$obs',$tc,
    										$subtotal,$descuento, $impuesto,@out_idFactura,@out_status);";
        ...
        function insDetSalPedidosCxC($tienda,$idFactura) {
        	$sql = "call spInsDetSalPedidosCxC($tienda,$idFactura,@out_status);";
