<?php /* Smarty version Smarty-3.1.16, created on 2016-08-31 16:35:14
         compiled from "../apartados/view/allApartados.tpl" */ ?>
<?php /*%%SmartyHeaderCode:95948186755f6d4e3b84941-35672066%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6502cd15a63708ad68cc66eedcb85260d0a28642' => 
    array (
      0 => '../apartados/view/allApartados.tpl',
      1 => 1471877278,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '95948186755f6d4e3b84941-35672066',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_55f6d4e3be00e4_08646558',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'NOMBRE_TIENDA' => 0,
...
<?php if ($_valid && !is_callable('content_55f6d4e3be00e4_08646558')) {function content_55f6d4e3be00e4_08646558($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['lP']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
							<tr style="padding:0px;" id="tr<?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idApartado'];?>
">
                                <td style="width:385px; text-align:left"> 
                                	<a style="color:#004C66;" href="#" 
                                		id="<?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idApartado'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['nombre'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['userVendedor'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['subTotal'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['descuento'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['impuesto'];?>
|<?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['TotalN'];?>
"
                                		onclick="getDetApartado(this.id)"><?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['nombre'];?>

                                	</a>
                                </td>
     							<td style="width:40px;  text-align:right"><?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['idApartado'];?>
</td>  
                                <td style="width:385px; text-align:right"><?php echo $_smarty_tpl->tpl_vars['LISTA_APARTADOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['Total'];?>
</td>
							</tr> 
						<?php endfor; endif; ?>
					</table>
