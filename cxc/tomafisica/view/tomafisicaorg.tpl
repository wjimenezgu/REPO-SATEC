        ...
        <form class="form-horizontal" id='FormTomaFisica'  action="processTomaFisica.php"   method="POST">
        	...
        	<div class="row-fluid" >		
								...
								<div class="control-group" style="margin-left: -150px;" id="boxCriterios">
									<div class="controls">
                						...
                						<form style="margin:0px; padding:0px; float:right; margin-top:-5px;">
                							<input type="text"  accesskey="b" class="txt_search" id="texto-barras" name="texto-barras" value="" style="margin-top:4px;  font-size:1vw; width:300px;" placeholder="Codigo de Barras">
                							...
                							<input type="text"  accesskey="c" class="txt_search" id="texto-codigoprov" name="texto-codigoprov" value="" style="margin-top:4px; margin-left:20px; font-size:1vw; width:155px;" placeholder="Código Proveedor">
                							<input type="text"  id="descArticulo" name="descArticulo"  disabled value="" style="margin-top:4px; margin-left:20px; font-size:1vw; width:375px;" placeholder="Descripción">
                							<input type="number"  id="cantidad" name="cantidad" value="" style="margin-top:4px; margin-left:20px; font-size:1vw; width:75px;" placeholder="Cantidad">
				...
				<div  style="text-align:right;margin-top:-15px;">
					...
					<input name ="fClaveBodeguero" id="fClaveBodeguero" type="password" value="" placeholder="Codigo Bodeguero" >
...
//alert($("#id_tienda").val());
    	...
    	// primero se valida la clave del bodeguero con una pantalla modal
    	    ...
    	    document.getElementById('message-fields').innerHTML = "";
    	    if (($("#id_tienda").val()== "0") && (!validaBodeguero())){
