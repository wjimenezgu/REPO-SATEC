...
class modelcobrar {
    ...
    function getAllFacturas($idTienda) {
        ...
        $sql = "call spGetAllFacturas($idTienda,@out_status);";
        $rs = $this->db->Execute($sql);
      	$data = $rs->getArray();
		$rs->Close();
      	return $data;        
...
//echo $sql;exit;
    ...
    function impreFactura($codTienda,$idFactura,$esManual,$numFactuManual,$formaPago1,$autorizacion1,$montoPago1,$formaPago2,$autorizacion2,$montoPago2,$formaPago3,$autorizacion3,$montoPago3,$formaPago4,$autorizacion4,$montoPago4,$impuesto) {
    	 
    	$sql = "call spImpreFactura($codTienda,$idFactura,'$esManual','$numFactuManual','$formaPago1','$autorizacion1',$montoPago1,'$formaPago2','$autorizacion2',$montoPago2,'$formaPago3','$autorizacion3',$montoPago3,'$formaPago4','$autorizacion4',$montoPago4,$impuesto,@out_status);";
   //echo $sql;exit;
    	$rs = $this->db->Execute($sql);
