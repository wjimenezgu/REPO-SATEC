						...
						<fieldset>
							...
							<div class="row-fluid" id="detPago">
								<div class="span12">
									<table class="table" id="tblPago1">
										<tbody id="tbod">
                                			<tr>
                                				...
                                				<td>
                                				<button type="button" title="Agregar Otra Forma de Pago2" class="btn btn-small btn-success" id="btnHabilitaP2" onclick="HabilitaPago(2);"><i class="icon-plus icon-white"></i> </button>
                                				</td>
                                			</tr>
									...
									<table class="table" id="tblVuelto">
										<tbody id="tbod">
											<tr>
                                				<td colspan="3">
                                				</td>
	  ...
	  if (vValor=="E"){
		  ...
		  //alert("Efectivo");
		  	  ...
		  	  if (vValor=="T" || vValor=="C" || vValor=="R" || vValor=="N") {
		  	  	// con Tarjeta o Cheque o Transferencia
			  	//paga con tarjeta
