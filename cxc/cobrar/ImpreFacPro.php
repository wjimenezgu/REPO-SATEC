...
<input type="button" id="imprime" autofocus name="imprime"   style="margin-left:25%; margin-top:25%;font-size:48px" onclick="javascript:jsWebClientPrint.print('cmds=' + $('#cmds').val());<?php if($idTienda != 0){?>  window.location.href ='../facturacion/index.php'; <?php }if ($idTienda == 0){?>window.location.href ='../cobrar/index.php' <?php } ?>" value="Presionar Enter para volver al sistema ..." />
