<?php 
    ...
    $detalleFactura = $model->buscarDetFactArti($idFactura);
          ...
          //  $cmds .= "----------------------------------------";
            ...
            $cmds .= $newLine;
            $cmds .= "                   Impuesto:".substr('           ',1,12-strlen($headerFactura[0]["impuesto"])).$headerFactura[0]["impuesto"];
            $cmds .= $newLine;
            $cmds .= "                      Total:".substr('           ',1,12-strlen($headerFactura[0]["Total"])).$headerFactura[0]["Total"];
            $cmds .= $newLine . $newLine;    
