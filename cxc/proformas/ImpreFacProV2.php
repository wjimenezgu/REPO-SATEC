...
<body>
    ...
    <div style="width:100%">
            ...
            <input type="button" id="imprime" autofocus name="imprime"   style="margin-left:25%; margin-top:25%;font-size:48px" onclick="javascript:jsWebClientPrint.print();<?php if($idTienda != 0){?>  window.location.href ='../proformas/index.php'; <?php }if ($idTienda == 0){?>window.location.href ='../proformas/index.php' <?php } ?> " value="Presionar Enter para volver al sistema ..." />
