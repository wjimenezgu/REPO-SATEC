<?php /* Smarty version Smarty-3.1.16, created on 2016-08-30 15:13:20
         compiled from "../reparaciones/view/reparacion.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22702495155f7550a09cc90-80713036%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e88c75aaca753c21db5fad27c248f8ee6f16a85' => 
    array (
      0 => '../reparaciones/view/reparacion.tpl',
      1 => 1471877278,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22702495155f7550a09cc90-80713036',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_55f7550a0cc4d3_88416302',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'NOMBRE_TIENDA' => 0,
...
<?php if ($_valid && !is_callable('content_55f7550a0cc4d3_88416302')) {function content_55f7550a0cc4d3_88416302($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
				 	...
				 	<table>
						<tbody>
                    		...
                    		<div class="control-group "  id="boxFinRepa" >
								...
								<div class="controls">
									<select id="selectFinRepa" name ="selectFinRepa" style="width: 275px;" <?php if ($_smarty_tpl->tpl_vars['TOTREPA_OFF']->value=="S") {?> disabled<?php }?>>
                            			<option value="SI" <?php if ($_smarty_tpl->tpl_vars['REPARACION']->value[0]['Estado']=="Reparada"||$_smarty_tpl->tpl_vars['REPARACION']->value[0]['Estado']=="Cerrada") {?> selected<?php }?>>Si</option>									
                            			<option value="NO" <?php if ($_smarty_tpl->tpl_vars['REPARACION']->value[0]['Estado']=="Activa") {?> selected<?php }?>>No</option>
                        			</select>
                        		</div>
                    		</div>
                    	</td>				 	
...
" style="text-align: right;width: 100px;margin-left:-50px" <?php if ($_smarty_tpl->tpl_vars['TOTREPA_OFF']->value=="S") {?> readonly<?php }?>>
						</div>
				 	</div>
				 	</td>
				 	                    	<td style="width:150px;text-align:left">
