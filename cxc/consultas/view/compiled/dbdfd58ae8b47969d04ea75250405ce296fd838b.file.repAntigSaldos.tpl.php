<?php /* Smarty version Smarty-3.1.16, created on 2016-12-07 08:03:13
         compiled from "../consultas/view/repAntigSaldos.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1990812028580f8a473a05a3-83754905%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1990812028580f8a473a05a3-83754905',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_580f8a47406ca8_93578901',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'DATOS_TIENDA' => 0,
...
<?php if ($_valid && !is_callable('content_580f8a47406ca8_93578901')) {function content_580f8a47406ca8_93578901($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
...
?>
					<tr style="padding:0px;"> 
						<td style="text-align:right;padding-right:14px"><?php if ($_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]["Codigo"]=='TOTAL') {?>  <?php } else { ?><?php echo $_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]["Codigo"];?>
 <?php }?></td>
 ...
 <?php }?></td>  
						<td style="text-align:right; "><?php echo $_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['SinVencer'];?>
 </td>
                        <td style="text-align:right;"><?php echo $_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['Rango1'];?>
 </td>						
