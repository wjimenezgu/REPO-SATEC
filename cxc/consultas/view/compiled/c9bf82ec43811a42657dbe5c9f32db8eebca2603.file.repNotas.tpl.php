<?php /* Smarty version Smarty-3.1.16, created on 2017-01-19 21:03:31
         compiled from "../consultas/view/repNotas.tpl" */ ?>
<?php /*%%SmartyHeaderCode:52292461358818c13d01aa0-75663585%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c9bf82ec43811a42657dbe5c9f32db8eebca2603' => 
    array (
      0 => '../consultas/view/repNotas.tpl',
      1 => 1484884611,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '52292461358818c13d01aa0-75663585',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58818c13db36b4_33511790',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58818c13db36b4_33511790')) {function content_58818c13db36b4_33511790($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
...
?>
					<tr style="padding:0px;"> 
						<td><?php if ($_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]["NumNota"]=='TOTAL') {?>  <?php } else { ?><?php echo $_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]["NumNota"];?>
 <?php }?></td>  
						<td><?php if ($_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]["NumNota"]=='TOTAL') {?> TOTAL <?php } else { ?><?php echo $_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]["FecNota"];?>
 <?php }?></td>
						...
						<td style="text-align:right;"><?php if ($_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]["NumNota"]=='TOTAL') {?>  <?php } else { ?><?php echo $_smarty_tpl->tpl_vars['LISTA_MOVI']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]["PorceDesc"];?>
 <?php }?></td>
