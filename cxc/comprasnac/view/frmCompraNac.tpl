                        		...
                        		<tr>
                        			...
                        			<td>
                        			    <div class="control-group" style="margin-left:-50px;" id="boxTipoCambio">
											...
											<div class="controls">
												<input class="input-small focused" style="text-align:right;" name="tcambio" id="tcambio" type="text" placeholder="T.Cambio si Aplica" value="{$PEDIDO_NAC[0].tipoCambio}" >
											</div>
										</div>	
                        			</td>
                        		</tr>
                        		<tr>
                        			<td>
                        				<div class="control-group" id="boxGravado">
											...
											<div class="controls">
												<input class="input-medium focused" style="text-align:right;" name="gravado" id="gravado" type="text" placeholder="Total Gravado" value="{$PEDIDO_NAC[0].gravado}" >
											</div>
										</div>		
                        			</td>
                        			<td>
                        				<div class="control-group" id="boxImpuesto">
											...
											<div class="controls">
												<input class="input-medium focused" style="text-align:right;" name="impuesto" id="impuesto" type="text" placeholder="Total Impuesto" value="{$PEDIDO_NAC[0].impuesto}" >
											</div>
										</div>		
                        			</td>
                        			<td>
                        				<div class="control-group" id="boxDescuento">
											...
											<div class="controls">
												<input class="input-medium focused" style="text-align:right;" name="descuento" id="descuento" type="text" placeholder="Total Descuento" value="{$PEDIDO_NAC[0].descuento}" >
											</div>
										</div>		
                        			</td>
                        			<td>
                        				<div class="control-group" style="margin-left:-50px;"  id="boxTotal">
											...
											<div class="controls">
												<input class="input-medium focused" style="text-align:right;" name="total" id="total" type="text" placeholder="Total Factura" value="{$PEDIDO_NAC[0].total}" >
											</div>
										</div>		
                        			</td>
                        		</tr>
                        	...
                        	<table class="table table-striped table-bordered bootstrap-datatable" id="tableItem">
                                ...
                                <tbody id="tbod" name="tbod" onload="LimpiaCampos()">
                                	...
                                	{section name=lP loop=$DETPEDIDO_NAC} 								
						    			...
						    			<td style="width:455x;">{$DETPEDIDO_NAC[lP].descArti}
						    			  	<input name="item[]" id="{$DETPEDIDO_NAC[lP].idLinea}" type=hidden  value="{$DETPEDIDO_NAC[lP].descArti}">
						    			</td>
     									<td style="width:10px;">{$DETPEDIDO_NAC[lP].codArti}
     										<input name="codArti[]" id="{$DETPEDIDO_NAC[lP].idLinea}" type=hidden  value="{$DETPEDIDO_NAC[lP].codArti}">
     									</td>     									
     									<td style="width:10px; text-align:right;">
     										<input name="cant[]" id="{$DETPEDIDO_NAC[lP].idLinea}" type=number style="text-align: right; width:50px;" value="{$DETPEDIDO_NAC[lP].cantidad}">
     									</td>
     									<td style="width:100px; text-align:right;">
     										<input name="cost[]" id="{$DETPEDIDO_NAC[lP].idLinea}" type=number style="text-align: right; width:100px;" value="{$DETPEDIDO_NAC[lP].costoUnitario}">
     									</td>
										<td class="center">
