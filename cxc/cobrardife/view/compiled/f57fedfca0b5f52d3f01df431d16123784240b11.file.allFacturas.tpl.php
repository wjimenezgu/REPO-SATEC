<?php /* Smarty version Smarty-3.1.16, created on 2016-08-22 14:40:09
         compiled from "../cobrardife/view/allFacturas.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1831931965577704652b8019-52717294%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f57fedfca0b5f52d3f01df431d16123784240b11' => 
    array (
      0 => '../cobrardife/view/allFacturas.tpl',
      1 => 1471877279,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1831931965577704652b8019-52717294',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_57770465337866_79918670',
  'variables' => 
  array (
    'NAV_MENU' => 0,
    'NOMBRE_TIENDA' => 0,
...
<?php if ($_valid && !is_callable('content_57770465337866_79918670')) {function content_57770465337866_79918670($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['NAV_MENU']->value;?>
		...
		<div class="row-fluid sortable">
			...
			<div class="box span6">
				<div class="box-header well">
					<h2><i class="icon-th"></i>Lista de  Facturas Diferidas</h2>
...
"
     							...
     							<td style="width:40px;  text-align:right"><?php echo $_smarty_tpl->tpl_vars['LISTA_FACTURAS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lP']['index']]['numDocu'];?>
</td>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']["p"]['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['LISTA_FPAGOS']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
                                            					<option value="<?php echo $_smarty_tpl->tpl_vars['LISTA_FPAGOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['LISTA_FPAGOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['descCorta'];?>
</option>
                                        					<?php endfor; endif; ?>																														
								  						</select>
													</div>
...
"><?php echo $_smarty_tpl->tpl_vars['LISTA_FPAGOS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['descCorta'];?>
							...
							<div class="form-actions" style="text-align:right;margin-top:-15px;">
								...
								<button type="button" disabled onclick="impFactu('N');" id="btnImp" class="btn btn-large btn-warning"><i class="icon-bookmark icon-white"></i> Actualizar Forma Pago</button>
							</div>
...
//	    if ( $('#idTienda').val() == 0) {
			...
			window.location.href ='../cobrardife/';
//	    }else{
